...
def creaEsercizi():
	...
	esercizi.append(Esercizio('alzata frontale', [Muscolo('spalle', 'deltoide', ['anteriore'], 1), Muscolo('torso', '', ['clavicolare'], 1)]))
	esercizi.append(Esercizio('alzata frontale con bilanciere', [Muscolo('spalle', 'deltoide', ['anteriore'], 1), Muscolo('torso', '', ['clavicolare'], 1)]))
	...
	esercizi.append(Esercizio('croce panca piana', [Muscolo('torso', '', ['clavicolare', 'sternale', 'addominale'], 1)]))
	esercizi.append(Esercizio('croce panca inclinata', [Muscolo('torso', '', ['clavicolare'], 1), Muscolo('spalle', 'deltoide', ['anteriore'], 1)]))
	...
	esercizi.append(Esercizio('curl avambraccio con rotazione polso, presa neutra', [Muscolo('braccia', 'bicipite brachiale', ['lungo', 'breve'], 1), Muscolo('braccia', 'brachioradiale', [], 2), Muscolo('braccia', 'brachiale', [], 2), Muscolo('spalle', 'deltoide', ['anteriore'], 3), Muscolo('torso', '', ['clavicolare'], 3)]))
	...
	esercizi.append(Esercizio('dip', [Muscolo('torso', '', ['addominale']), Muscolo('braccia', 'tricipite brachiale', ['lungo', 'laterale', 'mediale']), Muscolo('spalle', 'deltoide', ['anteriore'])]))
	esercizi.append(Esercizio('dip inverso', [Muscolo('braccia', 'tricipite brachiale', ['lungo', 'laterale', 'mediale']), Muscolo('torso', '', ['clavicolare', 'sternale', 'addominale']), Muscolo('spalle', 'deltoide', ['anteriore'])]))
	esercizi.append(Esercizio('distensione panca piana', [Muscolo('torso', '', ['clavicolare', 'sternale', 'addominale'], 1), Muscolo('braccia', 'tricipite brachiale', ['lungo', 'mediale'], 2), Muscolo('spalle', 'deltoide', ['anteriore'], 2)]))
	esercizi.append(Esercizio('distensione panca inclinata', [Muscolo('torso', '', ['clavicolare'], 1), Muscolo('braccia', 'tricipite brachiale', ['lungo', 'mediale'], 2), Muscolo('spalle', 'deltoide', ['anteriore'], 2)]))
	esercizi.append(Esercizio('distensione panca reclinata', [Muscolo('torso', '', ['addominale'], 1), Muscolo('braccia', 'tricipite brachiale', ['lungo', 'mediale'], 2), Muscolo('spalle', 'deltoide', ['anteriore'], 2)]))
	...
	esercizi.append(Esercizio('lento avanti', [Muscolo('spalle', 'deltoide', ['anteriore', 'laterale'], 1), Muscolo('torso', '', ['clavicolare'], 1), Muscolo('dorso', 'trapezio', ['discendente', 'trasverso', 'ascendente'], 2), Muscolo('braccia', 'tricipite brachiale', ['lungo', 'mediale'], 2)]))
	...
	esercizi.append(Esercizio('trazione sbarra avanti, presa supina', [Muscolo('dorso', 'dorsale', ['vertebrale', 'scapolare', 'iliaco', 'costale'], 1), Muscolo('dorso', 'rotondo grande', [], 1), Muscolo('braccia', 'bicipite brachiale', ['lungo', 'breve'], 1), Muscolo('braccia', 'brachiale', [], 1), Muscolo('braccia', 'brachioradiale', [], 1), Muscolo('dorso', 'trapezio', ['trasverale', 'ascendente'], 2), Muscolo('torso', '', ['clavicolare', 'trasversale', 'addominale'], 3)]))
	esercizi.append(Esercizio('trazione sbarra dietro', [Muscolo('dorso', 'dorsale', ['iliaco', 'costale'], 1), Muscolo('spalle', 'rotondo grande', [], 1), Muscolo('dorso', 'trapezio', ['ascendente'], 1), Muscolo('braccia', 'bicipite brachiale', ['lungo', 'breve'], 2), Muscolo('braccia', 'brachiale', [], 2), Muscolo('braccia', 'brachioradiale', [], 2), Muscolo('torso', '', ['clavicolare', 'trasversale', 'addominale'], 3)]))
	return esercizi
